## Visual Studio 2019 Server Source Code
...
namespace serserser
{
    ...
    class sokets
    {
        public sokets()
        {
            string bintIp = "Server IP";   // Server IP
    ...
    class login
    {
        public string log_in(string b, string c)
        {
            ...
            // MySQL 연결 변수
            // ServerIP = host IP, Uid, Pwd = DataBase ID, PW
            string strconn = "Server=ServerIP;Database=Aria;Uid='';Pwd='';";  
