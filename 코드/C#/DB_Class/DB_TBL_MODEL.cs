...
namespace DB_Class
{
    class DB_TBL_MODEL
    {
        ...
        public string Model_Temp;
        public string Model_Humidity;
        public string Model_Aname;

        public static string Model_All_Info;

        public static List<string> List_Model_Id = new List<string>();
        public static List<string> List_Model_Temp = new List<string>();
        public static List<string> List_Model_Humidity = new List<string>();
        public static List<string> List_Aname = new List<string>();
        ...
        public static void Model_Update(string model_id, string model_temp, string model_humidity, string aname) // Model Update 메소드
        {
            ...
            string Model_Update_Sql = "update TBL_MODEL set model_id = " + model_id + ", model_temp = " + model_temp + ", model_humidity = "
                        + model_humidity + ", aname = '" + aname + "' where model_id = " + model_id + ";";
