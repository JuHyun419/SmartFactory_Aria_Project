...
namespace DB_Class
{
    class DB_TBL_PRODUCTS
    {
        ...
        public static void Products_Insert(string _id, string model, string line_id, string lot_id, string working_state) // Products Insert 메소드
        {
            conn.Open(); // Mysql Open
            string Products_Insert_Sql = "INSERT INTO TBL_PRODUCTS (_id, model, line_id, lot_id, working_state, imsp_time) VALUES(" + _id + ",'" + model + "','" + line_id + "','" + lot_id + "'," + working_state + ",now());"; // Insert 쿼리문
        ...
        public static void Products_Update(string model_temp, string model_humidity, string working_state, string insp_result, string fail_reason, string _id) // Model Update 메소드
        {
            conn.Open();
            string Products_Update_Sql = "update TBL_PRODUCTS set model_temp = " + model_temp + ", model_humidity = " + model_humidity + ", working_state = "
                        + working_state + ", insp_result = '" + insp_result + ", fail_reson = '" + fail_reason + "', insp_time = now() imsp_ where _id = " + _id + ";";
